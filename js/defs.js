var tileDefs = {
  ...
  9: {
    name: "WATER CURRENT",
    extraDataName: "Strength (0=full force left, 255=full force right)",
  },
  10: { name: "ICE BLOCK" },
  11: { name: "POP BLOCK" },
  17: {
    name: "ITEM BLOCK STANDARD",
    extraDataName: "Content",
    extraDataType: "objId",
  },
...
var objDefs = {
  ...
  18: {
    ...
    paramDefs: [{ name: "fly" }, { name: "variant" }],
  },
  19: {
  ...
  21: {
    name: "FLYING FISH",
    paramDefs: [{ name: "delay" }, { name: "impulse" }],
  },
  22: {
    name: "PIRANHA PLANT",
    paramDefs: [{ name: "variant" }, { name: "direction" }],
  },
  ...
  35: {
    name: "BILL BLASTER",
    paramDefs: [{ name: "delay" }, { name: "direction" }],
  },
  ...
  49: {
    name: "HAMMER BRO",
    paramDefs: [{ name: "phase" }, { name: "slow hammer" }],
  },
  81: { name: "MUSHROOM" },
  82: { name: "FIRE FLOWER" },
  83: { name: "ONEUP" },
  ...
  161: {
    ...
    paramDefs: [{ name: "dir" }, { name: "owner" }, { name: "skin" }],
  },
  162: { name: "FIRE BREATH PROJECTILE" },
  163: {
    name: "HAMMER PROJECTILE",
    paramDefs: [{ name: "owner" }, { name: "delay" }],
  },
  177: { name: "FLAG" },
  253: {
    name: "TEXT",
