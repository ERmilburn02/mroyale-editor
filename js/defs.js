var tileDefs = {
    ...
    10:  {'name': 'ICE BLOCK'},
    11:  {'name': 'POP BLOCK'},
    12:  {'name': 'CONVEYOR BLOCK', 'extraDataName': 'Velocity (0=full speed left, 128=off, 255=full speed right)'},
...
var objDefs = {
    ...
    33:  {'name': 'FIRE BAR', 'paramDefs': [{'name': 'phase'}, {'name': 'length'}, {'name': 'clockwise'}, {'name': 'speed mult'}]},
    ...
    49:  {'name': 'HAMMER BRO', 'paramDefs': [{'name': 'phase'}, {'name': 'slow hammer'}]},
    81:  {'name': 'MUSHROOM'},
    82:  {'name': 'FIRE FLOWER'},
    83:  {'name': 'ONEUP'},
    84:  {'name': 'STAR'},
